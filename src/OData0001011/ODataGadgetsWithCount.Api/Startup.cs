...
namespace OData0001010_Gadgets.Api
{
    public class Startup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Odata Products", Version = "v1" });
            });
        }
        ...
        public virtual void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Odata Products v1"));
            }
        ...
        public IEdmModel GetEntityDataModel()
        {
            ...
            builder.EntitySet<Product>("GadgetsOdata");
